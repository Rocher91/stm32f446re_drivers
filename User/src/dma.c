...
static uint16_t sensor_data_arr[BUFFER_SIZE] = {892,731,1234,90,23};
static uint16_t temp_data_arr[BUFFER_SIZE];
...
int main(void)
{
	...
	DMA2_Transfer_Start( sensor_data_arr, temp_data_arr, BUFFER_SIZE);
